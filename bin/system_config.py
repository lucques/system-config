...
class SystemConfig:
    ...
    @staticmethod
    def run_ansible(playbook_name, private=False, verbose=False):
        '''
    ...
    def activate(config_name, private=False, verbose=False):
        ...
        print()
        SystemConfig.run_ansible(config_name, private=private, verbose=verbose)
